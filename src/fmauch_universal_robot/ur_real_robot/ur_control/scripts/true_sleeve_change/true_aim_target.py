...
class TrueAimTarget(TrueBase):
    def get_tgt_pose_in_world_frame(self,all_info):
        ...
        tgt_pose_in_real_frame.position.x = -self.x_shift + 0.007
        tgt_pose_in_real_frame.position.y = -self.y_shift + 0.054
        # tgt_pose_in_real_frame.position.y = -self.y_shift
        tgt_pose_in_real_frame.position.z = -self.z_shift - 0.03
