...
if("TRUE" STREQUAL "TRUE")
  set(ur_msgs_SOURCE_PREFIX /home/cn/NeuralSymbol_AI_for_task2/src/Universal_Robots_ROS_Driver/ur_msgs)
  set(ur_msgs_DEVEL_PREFIX /home/cn/NeuralSymbol_AI_for_task2/devel)
  set(ur_msgs_INSTALL_PREFIX "")
  set(ur_msgs_PREFIX ${ur_msgs_DEVEL_PREFIX})
else()
  set(ur_msgs_SOURCE_PREFIX "")
  set(ur_msgs_DEVEL_PREFIX "")
  set(ur_msgs_INSTALL_PREFIX /home/cn/NeuralSymbol_AI_for_task2/install)
...
if(NOT "/home/cn/NeuralSymbol_AI_for_task2/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ur_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/cn/NeuralSymbol_AI_for_task2/src/Universal_Robots_ROS_Driver/ur_msgs/${idir}'.  ${_report}")
    endif()
